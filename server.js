// server.js - CÓDIGO FINAL COM ROTA DE CURRÍCULO
...
const curriculoRoutes = require('./src/routes/curriculoRoutes'); // <-- NOVO: Rota de Currículo
...
app.use('/api/curriculo', curriculoRoutes); // <-- NOVO: Conexão da Rota de Currículo
